(function (globalScope) {
  ...
  function createInspector(environment) {
    ...
    function startObservers() {
      ...
      observeOpenShadowRoots();
      windowRef.addEventListener('resize', refresh, true);
      windowRef.addEventListener('scroll', refresh, true);
    }
    ...
    function stopObservers() {
      ...
      cleanupRootObservers();
      windowRef.removeEventListener('resize', refresh, true);
      windowRef.removeEventListener('scroll', refresh, true);
    }
